      ...
      >
        <div className={styles.logos}>
          <div className={styles.imgBox}>
            <img
              src={logoTitle}
              style={{ width: '480px', filter: darkMode ? 'invert(0)' : 'invert(1)' }}
              alt="Vitron"
            />
          </div>
        </div>
        ...
        <Box sx={{ mb: 5, mt: 2.5, maxWidth: 500 }}>
          {ipcRenderer && (
            <Chip avatar={<Avatar alt="Electron" src={electronImg} />} label="Electron" />
          )}
          <Chip avatar={<Avatar alt="Vite" src={vite} />} label="Vite" />
          <Chip avatar={<Avatar alt="React" src={react} />} label="React" />
          <Chip avatar={<Avatar alt="Typescript" src={typescript} />} label="Typescript" />
          <Chip avatar={<Avatar alt="Material UI" src={muiImg} />} label="Material UI" />
          <Chip avatar={<Avatar alt="Zustand" src={zustand} />} label="Zustand" />
          {/* <Chip avatar={<Avatar alt="Immer" src={immer} />} label="Immer" /> */}
          <Chip avatar={<Avatar alt="React Router" src={reactRouter} />} label="React Router" />
        </Box>
